  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text('Centro Creativo', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
          const SizedBox(height: 4),
          const Text('Aprende, escribe y desafia tu mente.', style: TextStyle(color: Colors.grey, fontSize: 14)),
